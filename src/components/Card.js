...
Свяжите класс Card c попапом. Сделайте так, чтобы Card принимал 
в конструктор функцию handleCardClick.
...
export default class Card {
  ...
  _setEventListeners() {
    ...
    this._cardElementImage.addEventListener('click', this._openPopupCard.bind(this));
  }
}